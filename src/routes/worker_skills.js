...
module.exports = (server) => {
     ...
     */
    server.get("/api/v1/workers/:worker_id/skills", verifyToken, workerSkillsHandler.getAllWorkerSkills);
     ...
     * Endpoint: /api/v1/workers/:worker_id/skills/:skill_id
     */
    server.delete("/api/v1/workers/:worker_id/skills/:skill_id", verifyToken, workerSkillsHandler.deleteWorkerSkills);
}
