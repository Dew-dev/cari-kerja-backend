...
6. The backend conversation only has read access to the frontend repository located at C:\Users\Hakim\Documents\Freelance\job-portal\cari-kerja-frontend. Do not attempt to write or modify any files in the frontend repository from this conversation. Instead, provide instructions or an implementation plan for the frontend agent.
